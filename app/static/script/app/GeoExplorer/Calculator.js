...
/* Placeholder dummy gettext function to avoid errors */
/* FIXME(Ariel): Remove when loading order ensures the real one is available */
...
/** api: constructor
 *  .. class:: GeoExplorer.Calculator
 *
 *    GeoExplorer Calculator plugin.
 */
GeoExplorer.plugins.Calculator = Ext.extend(gxp.plugins.Tool, {
    ...
    addOutput: function(config) {
        ...
        return GeoExplorer.plugins.Calculator.superclass.addOutput.apply(this, [[{
            id: "calcform",
...
Ext.preg(GeoExplorer.plugins.Calculator.prototype.ptype, GeoExplorer.plugins.Calculator);
